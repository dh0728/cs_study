...
<p align="center">
  <img src="img\cs_study_cover.svg" alt="coding" />
</p>
...
## About
인공지능사관학교 7기 교육생들의 CS 스터디 기록 저장소입니다. 알고리즘, 자료구조, 운영체제, 네트워크, 데이터베이스 등 개발자라면 반드시 갖춰야 할 컴퓨터공학 기초 지식을 이론부터 구현까지 함께 공부합니다. 매주 돌아가며 주제를 발표하고, 공부한 내용을 문서화해 CS 전반에 대한 지식을 쌓기 위한 공간입니다.
...
<a href="https://github.com/dh0728">
  <img src="https://github.com/dh0728.png" width="100">
</a>
<a href="https://github.com/dh0728">
  <img src="https://github.com/dh0728.png" width="100">
</a>
...
### Reference
- [Seogeurim/CS-study](https://github.com/Seogeurim/CS-study?tab=readme-ov-file#data-structure-%EC%9E%90%EB%A3%8C%EA%B5%AC%EC%A1%B0)
...
- 네트워크 기초
  - [OSI 7계층](./contents/network/osi-7layer.md)
  - [TCP / UDP](./contents/network/tcp-udp.md)
- 애플리케이션 계층
  - [HTTP / HTTPS](./contents/network/http-https.md)
  - [DNS](./contents/network/dns.md)
  - [쿠키 / 세션](./contents/network/cookie-session.md)
- 인프라
  - [로드 밸런싱](./contents/network/load-balancing.md)

📝 [면접 대비 질문](./contents/network/면접대비질문.md)
...
- 관계형 데이터베이스
  - [RDBMS](./contents/database/rdbms.md)
  - [SQL](./contents/database/sql.md)
  - [정규화 (Normalization)](./contents/database/normalization.md)
- 성능 및 신뢰성
  - [인덱스 (Index)](./contents/database/index.md)
  - [트랜잭션 (Transaction)](./contents/database/transaction.md)
- [NoSQL](./contents/database/nosql.md)

📝 [면접 대비 질문](./contents/database/면접대비질문.md)
...
- 설계 원칙
  - [SOLID 원칙](./contents/design-pattern/solid.md)
- GoF 패턴
  - [생성 패턴 (Creational)](./contents/design-pattern/creational.md)
  - [구조 패턴 (Structural)](./contents/design-pattern/structural.md)
  - [행동 패턴 (Behavioral)](./contents/design-pattern/behavioral.md)
