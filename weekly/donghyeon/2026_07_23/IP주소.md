...
**라우팅(Routing)은 네트워크에서  [](https://jhlee-developer.tistory.com/entry/CS-%EB%9D%BC%EC%9A%B0%ED%8C%85-%EA%B0%9C%EB%85%90%EA%B3%BC-%EB%9D%BC%EC%9A%B0%ED%84%B0-%EB%9D%BC%EC%9A%B0%ED%8C%85-%ED%85%8C%EC%9D%B4%EB%B8%94#)데이터(패킷)를 보낼 때 최적의 경로를 선택하는 과정**이며 라우터가 이를 수행한다.
